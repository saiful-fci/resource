...
@section('content')
    ...
    {!! Form::open(array('class' => 'form-horizontal form-wrp no-show-print')) !!}
    <div class="col-md-12">
        <div class="widget stacked">
            <div class="widget-header">
                <i class="icon-plus-sign"></i>
                <h3>Transport Route Assign Form</h3>
            </div> <!-- /widget-header -->
    ...
    <div class="col-md-12">
        <div class="widget stacked">
            ...
            <div class="widget-content progressReportDiv" id="wrp-bg">
                ...
                <form action="{{URL::to('routeAssign')}}" method="POST">
                    {{csrf_field()}}
    ...
    @include('fees.differPayable.transportAjaxRequest')
